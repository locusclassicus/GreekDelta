...
```{r}
sp_u <- size.penalize(mfw = c(100, 200, 500), corpus.dir = "Unicode",
sample.size.coverage = c(1000, 3000, 5000), sample.with.replacement = TRUE, iterations = 100, classification.method = "delta")
...
```{r}
sp_b <- size.penalize(mfw = c(100, 200, 500), corpus.dir = "Betacode", sample.size.coverage = c(1000, 3000, 5000), sample.with.replacement = TRUE, iterations = 100, classification.method = "delta")
